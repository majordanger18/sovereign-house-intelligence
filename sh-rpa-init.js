...
function openRPABuilder(id){
  ...
  const rpaData={
    ...
    emd_account:"escrow",
    loan_type:"other",
    loan_other_specify:"Hard Money (Kiavi)",
    ...
    addenda_line1:"Proof of Funds Addendum",
